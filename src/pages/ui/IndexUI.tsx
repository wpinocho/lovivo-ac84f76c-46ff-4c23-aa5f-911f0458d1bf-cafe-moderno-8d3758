  ...
  return (
    <EcommerceTemplate showCart={true}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.6s' }}>
              ...
              <Button size="lg" variant="outline" className="border-primary/50 text-white bg-black/50 backdrop-blur font-bold text-lg px-8 py-6 hover:bg-primary/10 hover:scale-105 transition-transform">
                Ver Ofertas
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto animate-scale-in" style={{ animationDelay: '0.8s' }}>
            <div className="text-center">
              ...
              <div className="text-sm text-white/60">Cafés servidos</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-white/60">Café premium</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12 animate-slide-up">
            ...
            {selectedCollectionId && (
              <Button 
                ...
                className="border-primary/50 hover:bg-primary/10 font-bold text-white bg-black/50 backdrop-blur"
              >
                Ver Todo
              </Button>
            )}
          ...
          {loading ? (
            ...
            <div className="text-center py-20 animate-fade-in">
              <Coffee className="h-16 w-16 text-white/30 mx-auto mb-4 opacity-50" />
      ...
      <section className="py-20 relative overflow-hidden bg-black">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-black to-accent/5"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl bg-card/50 backdrop-blur border border-primary/20 hover-lift card-glow animate-slide-up">
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Energía Instantánea</h3>
              <p className="text-white/60">Café premium que te activa desde el primer sorbo</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-card/50 backdrop-blur border border-accent/20 hover-lift card-glow animate-slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <h3 className="text-xl font-bold mb-2 text-white">Hecho con Amor</h3>
              <p className="text-white/60">Cada bebida es preparada con pasión y dedicación</p>
            </div>
            ...
            <div className="text-center p-8 rounded-2xl bg-card/50 backdrop-blur border border-secondary/20 hover-lift card-glow animate-slide-up" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-white/60">Solo usamos los mejores granos del mundo</p>
            </div>
          </div>
        </div>
      </section>
